...
<html lang="en">
  ...
  <body ondragstart="return false" onselectstart="return false">
    ...
    <main>
      ...
      <?php
      //view
      $sql = "SELECT * FROM users WHERE user_type='admin' AND user_username = '$access'";
        ...
        <div id="container-error">
          <div class="con-view" id="con-view">
            <img
              ...
              alt="user-icon"
            />
            <h1 id="notifmes"><?php echo $uname ?></h1>
      ...
      <div class="main">
        <div class="content">
          ...
          <div class="details">
            ...
            <p>Name: <b style="text-transform: capitalize;"><?php echo $uname ?></b></p>
            <p>Position: <b>Admin</b></p>
          </div>
          <div class="details">
            <p id="label-header">
    ...
    <div class="modal-container" id="pic01">
      <div class="modal-content">
        <form action="./mysql/profile/add-profile.php" method="POST" enctype="multipart/form-data">
          ...
          <br />
          <p>Upload your new profile picture. <br><b>Please rename your image filename, to this format: (lastname_firstname_college-acronym) <br> if possible..</b></p>
          <br />
    ...
    <div class="modal-container" id="basic01">
      <div class="modal-content">
        <form action="./mysql/profile/add-info.php" method="POST">
          ...
          <input
            type="text"
            placeholder="First Name Last Name" style="text-transform: capitalize;" maxlength="50" value="<?php echo $uname ?>" name="user-name" required
          /><br />
          <label for="">Position: </label><br />
          <input type="text" value="Admin (default)" id="def" title="Default" disabled />
          <br />
          <div class="pro-button">
            <button type="button" id="cancel" onclick="closeModal()">
              <span class="fas fa-times"></span> Cancel
    ...
    <div class="modal-container" id="up01">
      <div class="modal-content">
        <form action="./mysql/profile/add-credential.php" method="POST">
          ...
          <input type="text" value="<?php echo $password ?>" autocomplete="off" maxlength="20" name="user-password" required/>
          <br />
          <div class="pro-button">
            <button type="button" id="cancel" onclick="closeModal()">
              <span class="fas fa-times"></span> Cancel

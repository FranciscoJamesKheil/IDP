  ...
  <body ondragstart="return false" onselectstart="return false">
    ...
    <nav class="side-nav">
      ...
      <ul>
        ...
        >
        <a href="./matrix.php"
          ><li><span class="fas fa-cogs"></span>Matrix</li></a
        >
    ...
    <main>
      ...
      <div class="system">
        <h2>Suitable Browser</h2>
        <div class="best">
          <div class="browser">
            <img src="../font/assets/icon/chrome.png" alt="chrome">
            <div class="browser-col">
              <p id="chrome-text">Google Chrome (99%)</p>
              <div class="line"></div>
            </div>
          </div>
          <div class="browser">
            <img src="../font/assets/icon/microsoft.png" alt="chrome">
            <div class="browser-col">
              <p id="chrome-text">Microsoft Edge (90%)</p>
              <div class="line2"></div>
            </div>
          </div>
          <div class="browser">
            <img src="../font/assets/icon/firefox.png" alt="chrome">
            <div class="browser-col">
              <p id="chrome-text">Mozilla Firefox (80%)</p>
              <div class="line3"></div>
            </div>
          </div>
        </div>

...
<body>
    <?php
        ...
        if(isset($_POST['submit'])){
            ...
            $sql = "UPDATE `faculty` SET `faculty_firstname`='$fn', `faculty_lastname`='$ln',`faculty_mi`='$mi',`faculty_email`='$email'  WHERE user_id_fk= $fid";
            $sqluser = "UPDATE `users` SET `user_name`='$ln, $fn' WHERE user_id= $fid";

...
<?php
    ...
    if(isset($_POST['actual-delete'])) {
        $id = $_POST['actual-sched-id'];

        $sql = "DELETE FROM `actualteachingload` WHERE sched_id = '$id'";

        if(mysqli_query($link, $sql)) {
                ?>
                <script>
                    location.href = "../../saturday.php";
                </script>
                <?php
        }
        else {
            ...
            echo "<br><br>";
            echo "<a href='../../saturday.php'><button type='button' id='btn-back'>Back to Saturday</button></a>";
            echo "</div>";
        }
    }
?>

  ...
  <body ondragstart="return false" onselectstart="return false">
    ...
    <main>
      ...
      <div class="actual-teaching" id="show-actual">
        ...
        <div class="scroll">
          <table id="ac-tbl" border="1">
            ...
            <?php          
              //view
              $sqlActual = "SELECT * FROM actualteachingload WHERE faculty_id_fk = $facultyID AND sched_day = 'MON' ORDER BY time_from*time_to ASC";
      ...
      <div class="modal-container" id="ac01">
        <div class="modal-content">
          <form action="./mysql/mon/add-actual.php" method="POST">
            <h2><span class="far fa-calendar"></span> Actual Teaching Load</h2>
            <br />
            <p>Add your new schedule for monday. Follow the input format.</p>
            <br />
            <input type="text" value="<?php echo $facultyID ?>" name="faculty-id" hidden>
            <input type="text" autocomplete="off" value="MON" name="actual-day" hidden>
            <label for="">Subject Code: </label>
            <input type="text" autocomplete="off" name="actual-subject" required />
            <label for="">Section: </label>
            <input type="text" autocomplete="off" placeholder="BSCS 3A" name="actual-section" required />
            ...
            <label for="">Time: <font color="red" id="conflictAlert"></font></label>
            <div class="time-gap">
              <p>From:</p>
            ...
            <input type="text" autocomplete="off" placeholder="CPADS 4" name="actual-room" required />
      ...
      <div class="modal-container" id="acedit01">
        <div class="modal-content">
          <form action="./mysql/mon/update-actual.php" method="POST">
            <h2><span class="far fa-calendar"></span> Actual Teaching Load</h2>
            <br />
            <p>Update your schedule for monday.</p>
            <br />
            <input type="text" id="actual-to-update" name="actual-schedid-update" hidden>
            <input type="text" value="MON" name="actual-day-update" hidden>
            ...
            <input
              ...
              required
            />
            <label for="">Time: <font color="red" id="conflictAlert-edit"></font></label>
            <div class="time-gap">
              <p>From:</p>
              <select
      ...
      <div class="modal-container" id="acdel01">
        ...
        <br /><br />
        <div class="modal-content">
          <form action="./mysql/mon/del-actual.php" method="POST">
      ...
      <div class="actual-teaching" id="show-overload">
        ...
        <div class="scroll">
          <table id="ac-tbl" border="1">
            ...
            <?php          
              //view
              $sqlOverload = "SELECT * FROM overload WHERE faculty_id_fk = $facultyID AND sched_day = 'MON' ORDER BY time_from*time_to ASC";
      ...
      <div class="modal-container" id="ol01">
        <div class="modal-content">
          <form action="./mysql/mon/add-overload.php" method="POST">
            <h2><span class="far fa-calendar"></span> Overload</h2>
            <input type="text" value="<?php echo $facultyID ?>" name="overload-id-o" hidden>
            <input type="text" value="MON" name="overload-day" hidden>
            <br />
            <p>Add your new schedule for monday.</p>
            <br />
            <label for="">Subject Code: </label>
            ...
            <input
              ...
              required
            />
            <label for="">Time: <font color="red" id="conflictAlert-ol"></font></label>
            <div class="time-gap">
              <p>From:</p>
      ...
      <div class="modal-container" id="oledit01">
        <div class="modal-content">
          <form action="./mysql/mon/update-overload.php" method="POST">
            <h2><span class="far fa-calendar"></span> Overload</h2>
            <br />
            <p>Update your new schedule for monday.</p>
            <br />
            <input type="text" id="overload-to-update" name="overload-schedid-update" hidden>
            <input type="text" value="MON" name="overload-day-update" hidden>
            ...
            <input
              ...
              required
            />
            <label for="">Time: <font color="red" id="conflictAlert-ol-edit"></font></label>
            <div class="time-gap">
              <p>From:</p>
              <select
      ...
      <div class="modal-container" id="oldel01">
        ...
        <br /><br />
        <div class="modal-content">
          <form action="./mysql/mon/del-overload.php" method="POST">
      ...
      <div class="actual-teaching" id="show-quasi">
        ...
        <div class="scroll">
          <table id="ac-tbl" border="1">
            ...
            <?php          
              //view
              $sqlQuasi = "SELECT * FROM quasiteachingload WHERE faculty_id_fk = $facultyID AND quasi_day = 'MON' ORDER BY time_from*time_to ASC";
      ...
      <div class="modal-container" id="quasi01">
        <div class="modal-content">
          <form action="./mysql/mon/add-quasi.php" method="POST">
              <input type="text" value="<?php echo $facultyID ?>" name="faculty-id-quasi" hidden>
              <input type="text" value="MON" name="quasi-day" hidden>
            ...
            <label for="">Time: <font color="red" id="conflictAlert-qua"></font></label>
            <div class="time-gap">
              <p>From:</p>
      ...
      <div class="modal-container" id="quaedit01">
        <div class="modal-content">
          <form action="./mysql/mon/update-quasi.php" method="POST">
            <h2><span class="far fa-calendar"></span> Quasi Teaching Load</h2>
            <input type="text" value="<?php echo $facultyID ?>" name="faculty-id-quasi-update" hidden>
            <input type="text" value="MON" name="quasi-day-update" hidden>
            ...
            <label for="">Time: <font color="red" id="conflictAlert-qua-edit"></font></label>
            <div class="time-gap">
              <p>From:</p>
              <select
      ...
      <div class="modal-container" id="quadel01">
        ...
        <br /><br />
        <div class="modal-content">
          <form action="./mysql/mon/del-quasi.php" method="POST">
            <h2>
    ...
    <script>
      ...
      function calac() {
        ...
        var i;
        var val=0;
        //verify the time conflict
        for(i=fromac/1*1; i<toqac; i+=0.5) {
            <?php
                for($j=0; $j < $arrlength ; $j++) {
            ?>
                if (i == <?php echo $conflict[$j] ?>)
                    val++;
                else
                    val;
            <?php
        ...
        if (validate > 0 && val > 0) {
          ...
          document.getElementById("conflictAlert").innerHTML=val + " consecutive conflict time by 30-minute";
        } else if (validate < 0) {
          document.getElementById("ac-hours").value = "";
          document.getElementById("ac-hours-put").value = "";
          document.getElementById("conflictAlert").innerHTML="from > to";
        } else if(fromac == toqac){
          document.getElementById("ac-hours").value = "";
          document.getElementById("ac-hours-put").value = "";
          document.getElementById("conflictAlert").innerHTML="the same value";
        } else {
          document.getElementById("ac-hours").value = validate;
          document.getElementById("ac-hours-put").value = validate;
          document.getElementById("conflictAlert").innerHTML="Available";
        }
      }
      //edit ac
      function calacedit() {
        ...
        if (validate > 0 && val > 0) {
          ...
          document.getElementById("conflictAlert-edit").innerHTML=val + " consecutive conflict time by 30-minute";
        } else if (validate < 0) {
          document.getElementById("ac-hours-edit").value = "";
          document.getElementById("ac-hours-edit-put").value = "";
          document.getElementById("conflictAlert-edit").innerHTML="from > to";
        } else if(fromac == toqac){
          document.getElementById("ac-hours-edit").value = "";
          document.getElementById("ac-hours-edit-put").value = "";
          document.getElementById("conflictAlert-edit").innerHTML="the same value";
        } else {
          document.getElementById("ac-hours-edit").value = validate;
          document.getElementById("ac-hours-edit-put").value = validate;
          document.getElementById("conflictAlert-edit").innerHTML="Available";
        }
      }
      function calol() {
        ...
        var val=0;
        //verify the time conflict
        for(i=fromol/1*1; i<toqol; i+=0.5) {
            <?php
                for($j=0; $j < $arrlength ; $j++) {
            ?>
                if (i == <?php echo $conflict[$j] ?>)
        ...
        if (validate > 0 && val > 0) {
          ...
          document.getElementById("conflictAlert-ol").innerHTML=val + " consecutive conflict time by 30-minute";
        } else if (validate < 0) {
          document.getElementById("ol-hours").value = "";
          document.getElementById("ol-hours-put").value = "";
          document.getElementById("conflictAlert-ol").innerHTML="from > to";
        } else if(fromol == toqol){
          document.getElementById("ol-hours").value = "";
          document.getElementById("ol-hours-put").value = "";
          document.getElementById("conflictAlert-ol").innerHTML="the same value";
        } else {
          document.getElementById("ol-hours").value = validate;
          document.getElementById("ol-hours-put").value = validate;
          document.getElementById("conflictAlert-ol").innerHTML="Available";
        }
      }
      //checking ol edit
      function caloledit() {
        ...
        if (validate > 0 && val > 0) {
          ...
          document.getElementById("conflictAlert-ol-edit").innerHTML=val + " consecutive conflict time by 30-minute";
        } else if (validate < 0) {
          document.getElementById("ol-hours-edit").value = "";
          document.getElementById("ol-hours-edit-put").value = "";
          document.getElementById("conflictAlert-ol-edit").innerHTML="from > to";
        } else if(fromol == toqol){
          document.getElementById("ol-hours-edit").value = "";
          document.getElementById("ol-hours-edit-put").value = "";
          document.getElementById("conflictAlert-ol-edit").innerHTML="the same value";
        } else {
          document.getElementById("ol-hours-edit").value = validate;
          document.getElementById("ol-hours-edit-put").value = validate;
          document.getElementById("conflictAlert-ol-edit").innerHTML="Available";
        }
      }
      //quasi
      function calq() {
        ...
        var val=0;
        //verify the time conflict
        for(i=fromqua/1*1; i<toqua; i+=0.5) {
            <?php
                for($j=0; $j < $arrlength ; $j++) {
            ?>
                if (i == <?php echo $conflict[$j] ?>)
        ...
        if (validate > 0 && val > 0) {
          ...
          document.getElementById("conflictAlert-qua").innerHTML=val + " consecutive conflict time by 30-minute";
        } else if (validate < 0) {
          document.getElementById("qua-hours").value = "";
          document.getElementById("qua-hours-put").value = "";
          document.getElementById("conflictAlert-qua").innerHTML="from > to";
        } else if(fromqua == toqua){
          document.getElementById("qua-hours").value = "";
          document.getElementById("qua-hours-put").value = "";
          document.getElementById("conflictAlert-qua").innerHTML="the same value";
        } else {
          document.getElementById("qua-hours").value = validate;
          document.getElementById("qua-hours-put").value = validate;
          document.getElementById("conflictAlert-qua").innerHTML="Available";
        }
      }
      function calqedit() {
        ...
        if (validate > 0 && val > 0) {
          ...
          document.getElementById("conflictAlert-qua-edit").innerHTML=val + " consecutive conflict time by 30-minute";
        } else if (validate < 0) {
          document.getElementById("qua-hours-edit").value = "";
          document.getElementById("qua-hours-edit-put").value = "";
          document.getElementById("conflictAlert-qua-edit").innerHTML="from > to";
        } else if(fromqua == toqua){
          document.getElementById("qua-hours-edit").value = "";
          document.getElementById("qua-hours-edit-put").value = "";
          document.getElementById("conflictAlert-qua-edit").innerHTML="the same value";
        } else {
          document.getElementById("qua-hours-edit").value = validate;
          document.getElementById("qua-hours-edit-put").value = validate;
          document.getElementById("conflictAlert-qua-edit").innerHTML="Available";
        }
      }
      ...
      function openOL() {
        ...
        document.getElementById("conflictAlert-ol").innerHTML="";
      }
      function openQuasi() {
        document.getElementById("quasi01").style.display = "block";
        document.getElementById("conflictAlert-qua").innerHTML="";
      }
      ...
      function closeModal() {
        ...
        //verifying conflicts
        document.getElementById("conflictAlert-edit").innerHTML="";
        document.getElementById("conflictAlert-ol-edit").innerHTML="";
        document.getElementById("conflictAlert-qua-edit").innerHTML="";

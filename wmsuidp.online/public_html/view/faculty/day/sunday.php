    ...
    <main>
      ...
      <div class="actual-teaching" id="show-actual">
        ...
        <div class="scroll">
          <table id="ac-tbl" border="1">
            ...
            <?php          
              //view
              $sqlActual = "SELECT * FROM actualteachingload WHERE faculty_id_fk = $facultyID AND sched_day = 'SUN'";
      ...
      <div class="modal-container" id="ac01">
        <div class="modal-content">
          <form action="./mysql/sun/add-actual.php" method="POST">
            <h2><span class="far fa-calendar"></span> Actual Teaching Load</h2>
            <br />
            <p>Add your new schedule for sunday.</p>
            <br />
            <input type="text" value="<?php echo $facultyID ?>" name="faculty-id" hidden>
            <input type="text" autocomplete="off" value="SUN" name="actual-day" hidden>
      ...
      <div class="modal-container" id="acedit01">
        <div class="modal-content">
          <form action="./mysql/sun/update-actual.php" method="POST">
            <h2><span class="far fa-calendar"></span> Actual Teaching Load</h2>
            <br />
            <p>Update your schedule for sunday.</p>
            <br />
            <input type="text" id="actual-to-update" name="actual-schedid-update" hidden>
            <input type="text" value="SUN" name="actual-day-update" hidden>
      ...
      <div class="modal-container" id="acdel01">
        ...
        <br /><br />
        <div class="modal-content">
          <form action="./mysql/sun/del-actual.php" method="POST">
      ...
      <div class="actual-teaching" id="show-overload">
        ...
        <div class="scroll">
          <table id="ac-tbl" border="1">
            ...
            <?php          
              //view
              $sqlOverload = "SELECT * FROM overload WHERE faculty_id_fk = $facultyID AND sched_day = 'SUN'";
      ...
      <div class="modal-container" id="oledit01">
        <div class="modal-content">
          <form action="./mysql/sun/update-overload.php" method="POST">
            <h2><span class="far fa-calendar"></span> Overload</h2>
            <br />
            <p>Update your new schedule for sunday.</p>
            <br />
            <input type="text" id="overload-to-update" name="overload-schedid-update" hidden>
            <input type="text" value="SUN" name="overload-day-update" hidden>
      ...
      <div class="modal-container" id="oldel01">
        ...
        <br /><br />
        <div class="modal-content">
          <form action="./mysql/sun/del-overload.php" method="POST">
      ...
      <div class="actual-teaching" id="show-quasi">
        ...
        <div class="scroll">
          <table id="ac-tbl" border="1">
            ...
            <?php          
              //view
              $sqlQuasi = "SELECT * FROM quasiteachingload WHERE faculty_id_fk = $facultyID AND quasi_day = 'SUN'";
      ...
      <div class="modal-container" id="quasi01">
        <div class="modal-content">
          <form action="./mysql/sun/add-quasi.php" method="POST">
              <input type="text" value="<?php echo $facultyID ?>" name="faculty-id-quasi" hidden>
              <input type="text" value="SUN" name="quasi-day" hidden>
      ...
      <div class="modal-container" id="quaedit01">
        <div class="modal-content">
          <form action="./mysql/sun/update-quasi.php" method="POST">
            <h2><span class="far fa-calendar"></span> Quasi Teaching Load</h2>
            <input type="text" value="<?php echo $facultyID ?>" name="faculty-id-quasi-update" hidden>
            <input type="text" value="SUN" name="quasi-day-update" hidden>
      ...
      <div class="modal-container" id="quadel01">
        ...
        <br /><br />
        <div class="modal-content">
          <form action="./mysql/sun/del-quasi.php" method="POST">
            <h2>

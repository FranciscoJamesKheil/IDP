<?php
    ...
    if(!isset($access))  {
	  ...
	  $id = $_GET['GetID'];
    $sql = "SELECT * FROM wodesignation WHERE id= '". $id . "' AND rank_type='Professors';";
      ...
      <section>
        ...
        <div class="modal-content">
          <form action="./update-matrix-1-1.php" method="POST">
            ...
            <input type="text" value="<?php echo $id ?>" name="prof-id" hidden>
            <div class="content">
              ...
              <div class="text-content">
                ...
                <input type="number" onchange="detect()" id="i" value="<?php echo $i ?>" name="instruction" placeholder="Hours" required>
              </div>
              <div class="text-content">
                <label for="">Research:</label>
                <input type="number" onchange="detect()" id="rep" value="<?php echo $rep ?>" name="research-ext-pro" placeholder="Hours" required>
              </div>
              <div class="text-content">
                <label for="">Extension:</label>
                <input type="number" onchange="detect()" id="ep" value="<?php echo $e ?>" name="extension" placeholder="Hours" required>
              </div>
              <p id="lbl-with">Strategic Functions</p>
              <div class="text-content">
                <label for="">Quality Assurance Process:</label>
                <input type="number" onchange="detect()" id="qa" value="<?php echo $qa ?>" name="assurance" placeholder="Hours" required>
              </div>
              <p id="lbl-with">Support & Other Functions</p>
              <div class="text-content">
                <label for="">Quasi:</label>
                <input type="number" onchange="detect()" id="q" value="<?php echo $q ?>" name="quasi" placeholder="Hours" required>
              </div>
              <div class="text-content">
                <label for="">Lesson Prep:</label>
                <input type="number" onchange="detect()" id="lp" value="<?php echo $lp ?>" name="lesson-prep" placeholder="Hours" required>
              </div>
              <div class="text-content">
                <label for="">Others:</label>
                <input type="number" onchange="detect()" id="o" value="<?php echo $o ?>" name="others" placeholder="Hours" required>
              </div>
            </div>
      ...
      <script>
        function detect() {
          ...
          if(i<0) {
            ...
            alert("Invalid value: Negative Hour...");
            document.getElementById("ep").value = <?php echo $e ?>;
          }
        }
      </script>
      <footer>

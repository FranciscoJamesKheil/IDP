...
<?php
    ...
    if(isset($_POST['update'])) {
        ...
        $sql = "UPDATE `wodesignation` SET `instruction`=$i,`research_ext_pro`=$rep,`extension`=$e,`quality_assurance`=$qa,`quasi`=$q,`lesson_prep`=$lp,`others`=$o WHERE rank_type = 'Professors' AND id = $id";
